	...
	<div class="container">
		...
		<?php
		    ...
		    if ( $success_stories->have_posts() ): ?>
		        ...
		        <?php while ( $success_stories->have_posts() ): ?>
		        <?php $success_stories->the_post(); ?>
		        ...
		        <div class="col-12 col-md-6 col-lg-4 col-xl-3 grid-item <?php echo $term_list1[0]; ?>">
			        ...
			        <a class="grid-link fadeIn" href="<?php the_permalink(); ?>" aria-label="<?php echo the_title(); ?>" data-scroll>
						    ...
						    <div class="image" style="background-image: <?php if ($success_story['hero_image']): ?>url(<?php echo $success_story['hero_image']['url']; ?>)<?php else: ?>url('/wp-content/uploads/2018/11/REDCOM_placeholder-logo.png');<?php endif; ?>"></div>
				        	<div class="meta"><?php echo $term_list1[0]; ?></div>
				        	<h3 class="title"><?php the_title(); ?></h3>
				        	<p class="summary"><?php echo $success_story['summary']; ?></p>
