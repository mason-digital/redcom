<?php /* Template Name: Capability Page */ ?>
...
<section id="content" role="main">
	<div class="container">
		<div class="row">
			<div class="<?php if($hero['sidebar_show']): echo 'col-lg-8'; else: echo 'col-12'; endif; ?>" style="padding-left:0px;">
