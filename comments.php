...
<section id="comments">
    ...
    <section id="trackbacks-list" class="comments">
        <h3 class="comments-title"><?php echo '<span class="ping-count">' . $ping_count . '</span> ' . ( $ping_count > 1 ? __( 'Trackbacks', 'redcom' ) : __( 'Trackback', 'redcom' ) ); ?></h3>
        <ul>
            <?php wp_list_comments( 'type=pings&callback=redcom_custom_pings' ); ?>
        </ul>
    </section>
